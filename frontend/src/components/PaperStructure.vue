<template>
  <div class="paper-structure">
    ...
    <div v-else class="space-y-6">
      <div v-for="section in sections" :key="section.section_id" class="section-item">
        <h3 class="font-bold mb-3 cursor-pointer hover:text-primary" :class="{
        ...
        <div v-show="expandedSections[section.section_id]" class="max-w-none"
